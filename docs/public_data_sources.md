...
## Theta and Ring Digitized Literature Data
...
| BYU thesis, "Numerical Model of Non-collinear SPDC" | `data/external/byu_noncollinear_spdc/byu_fig3_3_digitized.csv` | Ten Figure 3.3 ring-diameter points digitized from CCD and published computational series | Supplementary paper-internal comparison only because `351 nm / 690 +/- 5 nm` differs from the default configuration. |
